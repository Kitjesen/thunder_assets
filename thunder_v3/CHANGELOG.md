...
Packaged the updated Thunder small-wheel export as the root-level
`thunder_v4/` asset directory.
...
- Long SolidWorks export filenames were normalized to `thunder_v4.urdf` and
  `thunder_v4.csv`.
- Mesh references were normalized from generated `package://...` paths to
  repository-relative `../meshes/...` paths.
